...
ALTER TYPE "public"."NotificationType" ADD VALUE 'GAME_WAITLIST_OFFER';
ALTER TYPE "public"."NotificationType" ADD VALUE 'GAME_INVITATION';
ALTER TYPE "public"."NotificationType" ADD VALUE 'GAME_REMOVED_PEER';
ALTER TYPE "public"."NotificationType" ADD VALUE 'GAME_ROLE_UPDATE';
