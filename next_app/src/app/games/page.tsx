...
export default async function GamesPage(props: {
  ...
  // const games = await fetchGames(searchParams); // (Not used directly in this page component in your original code, seemingly handled by GamesByDateClient for the main list)
    ...
    <main>
       ...
       <Box 
         sx={{ 
           ...
           pt: 6, 
           pb: 8, 
           mb: -4, // Negative margin to overlap content
       ...
       <Container maxWidth="md">
         <Stack spacing={4}>
            ...
            {/* Joined Games Section (Overlapping the header slightly for effect) */}
                ...
                <Link href="/games/new" passHref legacyBehavior>
                    <Button
                        ...
                        sx={{
                            ...
                            background: 'linear-gradient(45deg, #2e7d32 30%, #66bb6a 90%)', // גרדיאנט ירוק מותאם אישית
                            '&:hover': {
